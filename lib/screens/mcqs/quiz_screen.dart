...
import 'package:pak_mega_mcqs/common/providers/setting_provider.dart';
...
class _QuizScreenState extends State<QuizScreen> {
  ...
  int totalQuestion = 0;
  int score = 0;
  String correct = "assets/audios/correct.mp3";
  String wrong = "assets/audios/wrong.mp3";
                              ...
                              children: [
                                ...
                                Flexible(
                                    child: ListView.builder(
                                        ...
                                        itemBuilder: (context, index) {
                                          List<Options> optionsList = model.options!;
                                          Options option = optionsList[index];
                                          Color color = getColorsForOptions(option, model);
                                          return InkWell(
                                            onTap: () async {
                                              int coins = context
                                                  .read<
                                            ...
                                            child: Container(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  getIconForOptions(option, model)
                                                ],
                                              ),
                                            ),
                                          );
  ...
  void gotoNext(int questionNumber) {
    ...
    if (pageController.page!.toInt() == questionList.length - 1) {
      ...
      var oldPoints = context.read<ProfileProvider>().userModel!.points;
