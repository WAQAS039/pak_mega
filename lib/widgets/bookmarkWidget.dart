...
import 'package:pak_mega_mcqs/model/options_model.dart';
...
class BookMarkWidget extends StatefulWidget {
  ...
  const BookMarkWidget({Key? key, required this.questionModel, required this.index,required this.fromWhich}) : super(key: key);

  @override
  State<BookMarkWidget> createState() => _MCQsQuestionWidgetState();
}

class _MCQsQuestionWidgetState extends State<BookMarkWidget> {
  // Eye Work
  ...
  String? bookmarkImage = 'assets/icons/mcqs_page_icons/bookmarked.png';
